...
while True:
    ...
    while user not in choices:
        ...
        print(f'Computer is {computer}') ### comment this line out at the end
    ...
    if user == computer: ### 3. changed users to user
        print("Looks like a tie") ### 1. closing bracket on print
    ...
    # check all cases if user is rock
        ...
        # check losing case
        elif computer == "paper": ### 4. Logic error changed rock to paper
    ...
    # check all cases if user is paper
        ...
        # check winning case
        if computer == "rock": ### 1. added : at end of line
            print("You win!")
    ...
    # check all cases if user is scissors
        ...
        # check losing case
            ...
            print("Sorry, You lose.") ### 5. changed Print to print