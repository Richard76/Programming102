...
Instead of one profile, you will need a list of profiles. Each profile be a dictionary containing key : value pairs with the keys of username and password.
